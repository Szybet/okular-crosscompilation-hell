...
#include <memory>
#include "../../../../../../frameworks/kitemviews/src/kcategorydrawer.h"
...
QT_MOC_LITERAL(5, 59, 15), // "actionRequested"
QT_MOC_LITERAL(6, 75, 6) // "action"

    },
    "KCategoryDrawer\0collapseOrExpandClicked\0"
    "\0QModelIndex\0index\0actionRequested\0"
    "action"
};
...
void KCategoryDrawer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KCategoryDrawer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (KCategoryDrawer::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KCategoryDrawer::collapseOrExpandClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (KCategoryDrawer::*)(int , const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KCategoryDrawer::actionRequested)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject KCategoryDrawer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_KCategoryDrawer.data,
    qt_meta_data_KCategoryDrawer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
