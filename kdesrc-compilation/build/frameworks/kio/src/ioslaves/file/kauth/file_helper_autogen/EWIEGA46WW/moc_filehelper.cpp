...
#include <memory>
#include "../../../../../../../../../frameworks/kio/src/ioslaves/file/kauth/filehelper.h"
...
QT_MOC_LITERAL(2, 16, 18), // "KAuth::ActionReply"
QT_MOC_LITERAL(3, 35, 0), // ""
QT_MOC_LITERAL(4, 36, 4) // "args"

    },
    "FileHelper\0exec\0KAuth::ActionReply\0\0"
    "args"
};
...
void FileHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { KAuth::ActionReply _r = _t->exec((*reinterpret_cast< const QVariantMap(*)>(_a[1])));
