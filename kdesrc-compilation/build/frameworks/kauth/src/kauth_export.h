...
#  define KAUTH_DECL_DEPRECATED __attribute__ ((__deprecated__))
#endif
...
#  define KAUTH_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56b00
#endif
...
#  else
#    define KAUTH_DEPRECATED_WARNINGS_SINCE 0x56b00
#  endif
#endif
