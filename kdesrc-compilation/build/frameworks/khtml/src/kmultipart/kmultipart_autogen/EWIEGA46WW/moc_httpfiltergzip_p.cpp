/****************************************************************************
** Meta object code from reading C++ file 'httpfiltergzip_p.h'
**
...
#include <memory>
#include "../../../../../../../frameworks/khtml/src/kmultipart/httpfiltergzip_p.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'httpfiltergzip_p.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 31, 9) // "slotInput"
    ...
    "HTTPFilterGZip\0output\0\0d\0error\0slotInput"
};
...
void HTTPFilterGZip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HTTPFilterGZip::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPFilterGZip::output)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HTTPFilterGZip::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPFilterGZip::error)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HTTPFilterGZip::output(const QByteArray & _t1)
{
...
// SIGNAL 1
void HTTPFilterGZip::error(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
