...
StatusNotifierItemAdaptor::StatusNotifierItemAdaptor(KStatusNotifierItemDBus *parent)
...
void StatusNotifierItemAdaptor::ProvideXdgActivationToken(const QString &token)
{
    // handle method call org.kde.StatusNotifierItem.ProvideXdgActivationToken
    parent()->ProvideXdgActivationToken(token);
}
