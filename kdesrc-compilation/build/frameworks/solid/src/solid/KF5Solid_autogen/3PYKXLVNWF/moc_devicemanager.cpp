...
#include <memory>
#include "../../../../../../../frameworks/solid/src/solid/devices/ifaces/devicemanager.h"
...
void Solid::Ifaces::DeviceManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceManager::deviceAdded)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Solid::Ifaces::DeviceManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Solid__Ifaces__DeviceManager.data,
    qt_meta_data_Solid__Ifaces__DeviceManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
