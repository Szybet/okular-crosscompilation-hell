...
#include <memory>
#include "../../../../../../../frameworks/solid/src/solid/devices/backends/udisks2/dbus/manager.h"
...
QT_MOC_LITERAL(5, 86, 13), // "VariantMapMap"
QT_MOC_LITERAL(6, 100, 25), // "interfaces_and_properties"
QT_MOC_LITERAL(7, 126, 17), // "InterfacesRemoved"
QT_MOC_LITERAL(8, 144, 10), // "interfaces"
QT_MOC_LITERAL(9, 155, 17), // "GetManagedObjects"
QT_MOC_LITERAL(10, 173, 36) // "QDBusPendingReply<DBUSManager..."
...
void OrgFreedesktopDBusObjectManagerInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OrgFreedesktopDBusObjectManagerInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->InterfacesAdded((*reinterpret_cast< const QDBusObjectPath(*)>(_a[1])),(*reinterpret_cast< const VariantMapMap(*)>(_a[2]))); break;
        ...
        case 2: { QDBusPendingReply<DBUSManagerStruct> _r = _t->GetManagedObjects();
            if (_a[0]) *reinterpret_cast< QDBusPendingReply<DBUSManagerStruct>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
        ...
        {
            using _t = void (OrgFreedesktopDBusObjectManagerInterface::*)(const QDBusObjectPath & , const VariantMapMap & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OrgFreedesktopDBusObjectManagerInterface::InterfacesAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OrgFreedesktopDBusObjectManagerInterface::*)(const QDBusObjectPath & , const QStringList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OrgFreedesktopDBusObjectManagerInterface::InterfacesRemoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OrgFreedesktopDBusObjectManagerInterface::staticMetaObject = { {
    QMetaObject::SuperData::link<QDBusAbstractInterface::staticMetaObject>(),
    qt_meta_stringdata_OrgFreedesktopDBusObjectManagerInterface.data,
    qt_meta_data_OrgFreedesktopDBusObjectManagerInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void OrgFreedesktopDBusObjectManagerInterface::InterfacesAdded(const QDBusObjectPath & _t1, const VariantMapMap & _t2)
{
