...
#define kdeconnectsmsplugin_EXPORTS 1
...
#define KPLUGINFACTORY_PLUGIN_CLASS_INTERNAL_NAME kdeconnectsmsplugin_factory
...
#define TRANSLATION_DOMAIN "purpose_kdeconnectsms"
