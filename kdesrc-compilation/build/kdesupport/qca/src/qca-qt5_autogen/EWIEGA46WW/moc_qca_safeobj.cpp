...
#include <memory>
#include "../../../../../../kdesupport/qca/src/qca_safeobj.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QCA__SafeSocketNotifier_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QCA__SafeSocketNotifier_t qt_meta_stringdata_QCA__SafeSocketNotifier = {
    {
QT_MOC_LITERAL(0, 0, 23), // "QCA::SafeSocketNotifier"
QT_MOC_LITERAL(1, 24, 9), // "activated"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 10), // "setEnabled"
...
void QCA::SafeSocketNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SafeSocketNotifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SafeSocketNotifier::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeSocketNotifier::activated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QCA::SafeSocketNotifier::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QCA__SafeSocketNotifier.data,
    qt_meta_data_QCA__SafeSocketNotifier,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QCA::SafeSocketNotifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QCA__SafeSocketNotifier.stringdata0))
...
// SIGNAL 0
void QCA::SafeSocketNotifier::activated()
{
