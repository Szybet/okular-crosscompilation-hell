...
{
    qDebug() << "DEBUG: pagesSizeString() function was launched.";
    if (m_generator) {
...
{
    qDebug() << "DEBUG: namePaperSize() function was launched.";
...
{
    qDebug() << "DEBUG: localizedSize() function was launched.";
...
{
    qDebug() << "DEBUG: calculateMemoryToFree() function was launched.";
...
{
    qDebug() << "DEBUG: cleanupPixmapMemory() function was launched.";
...
{
    qDebug() << "DEBUG: searchLowestPriorityPixmap() function was launched.";
...
{
    qDebug() << "DEBUG: getTotalMemory() function was launched.";
...
{
    qDebug() << "DEBUG: getFreeMemory() function was launched.";
...
{
    qDebug() << "DEBUG: loadDocumentInfo() function was launched.";
...
{
    qDebug() << "DEBUG: loadViewsInfo() function was launched.";
...
{
    qDebug() << "DEBUG: saveViewsInfo() function was launched.";
...
{
    qDebug() << "DEBUG: giveAbsoluteUrl() function was launched.";
...
{
    qDebug() << "DEBUG: openRelativeFile() function was launched.";
...
{
    qDebug() << "DEBUG: loadGeneratorLibrary() function was launched.";
...
{
    qDebug() << "DEBUG: loadServiceList() function was launched.";
...
{
    qDebug() << "DEBUG: cacheExportFormats() function was launched.";
    if (m_exportCached) {
        return;
    }
...
{
    qDebug() << "DEBUG: generatorConfig() function was launched.";
...
{
    qDebug() << "DEBUG: generatorSave() function was launched.";
    if (info.saveChecked) {
        return info.save;
    }
...
{
    qDebug() << "DEBUG: openDocumentInternal() function was launched.";
    ...
    if (!isstdin) {
        qDebug() << "loading document with password";
        ...
        if (m_generator->hasFeature(Generator::ReadRawData)) {
            qDebug() << "loading document without password";
            openResult = m_generator->loadDocumentFromDataWithPassword(filedata, m_pagesVector, password);
        } else {
            qDebug() << "m_tempFile path: being created";
            m_tempFile = new QTemporaryFile();
            if (!m_tempFile->open()) {
                delete m_tempFile;
                m_tempFile = nullptr;
            } else {
                qDebug() << "m_tempFile path:" << m_tempFile->fileName();
...
{
    qDebug() << "DEBUG: savePageDocumentInfo() function was launched.";
    if (infoFile->open()) {
        // 1. Create DOM
        QDomDocument doc(QStringLiteral("documentInfo"));
...
{
    qDebug() << "DEBUG: nextDocumentViewport() function was launched.";
...
{
    qDebug() << "DEBUG: performAddPageAnnotation() function was launched.";
...
{
    qDebug() << "DEBUG: performRemovePageAnnotation() function was launched.";
    Okular::SaveInterface *iface = qobject_cast<Okular::SaveInterface *>(m_generator);
    AnnotationProxy *proxy = iface ? iface->annotationProxy() : nullptr;
...
void DocumentPrivate::performModifyPageAnnotation(int page, Annotation *annotation, bool appearanceChanged)
{
    ...
    if (appearanceChanged && (annotation->flags() & Annotation::ExternallyDrawn)) {
        ...
        // Redraw everything, including ExternallyDrawn annotations
        qDebug(OkularCoreDebug) << "Refreshing Pixmaps";
        refreshPixmaps(page);
    }
}
...
{
    qDebug(OkularCoreDebug) << "performSetAnnotationContents";
...
{
    qDebug() << "sendGeneratorPixmapRequest";
...
{
    qDebug() << "slotFontReadingProgress";
...
{
    qDebug() << "slotGeneratorConfigChanged";
    if (!m_generator) {
        return;
    }
...
{
    qDebug() << "doContinueDirectionMatchSearch";
...
{
    qDebug() << "doContinueAllDocumentSearch";
...
{
    qDebug() << "isNormalizedRectangleFullyVisible";
...
{
    qDebug() << "clearAndWaitForRequests";
    m_pixmapRequestsMutex.lock();
...
{
    qDebug() << "updateMetadataXmlNameAndDocSize";
...
void Document::startFontReading()
{
    ...
    qDebug() << "startFontReading finished";

}

void Document::stopFontReading()
{
    qDebug() << "stopFontReading";
...
QVariant Document::metaData(const QString &key, const QVariant &option) const
{
    ...
    // source reference
    qDebug() << "DEBUG: metaData() function was launched.";
    ...
    qDebug() << "DEBUG: metaData() function finished.";
...
{
    qDebug() << "DEBUG: allPagesSize() function was launched.";
    ...
    qDebug() << "DEBUG: allPagesSize() function finished.";
}

QString Document::pageSizeString(int page) const
{
    qDebug() << "DEBUG: pageSizeString() function was launched.";
    if (d->m_generator) {
...
{
    qDebug() << "DEBUG: shouldCancelRenderingBecauseOf() function was launched.";
...
{
    qDebug() << "DEBUG: cancelRenderingBecauseOf() function was launched.";
...
{
    qDebug() << "DEBUG: requestPixmaps() function was launched.";
    if (requests.isEmpty()) {
        return;
    }
...
{
    qDebug() << "DEBUG: requestTextPage() function was launched.";
...
{
    qDebug() << "DEBUG: addPageAnnotation() function was launched.";
...
{
    qDebug() << "DEBUG: canModifyPageAnnotation() function was launched.";
...
{
    qDebug() << "DEBUG: prepareToModifyAnnotationProperties() function was launched.";
...
{
    qDebug() << "DEBUG: setPageTextSelection() function was launched.";
...
{
    qDebug() << "DEBUG: setViewport() function was launched.";
    if (!viewport.isValid()) {
...
{
    qDebug() << "DEBUG: setViewportPage() function was launched.";
...
{
    qDebug() << "DEBUG: setZoom() function was launched.";
    // notify change to all other (different from id) observers
    for (DocumentObserver *o : qAsConst(d->m_observers)) {
        if (o != excludeObserver) {
            o->notifyZoom(factor);
...
{
    qDebug() << "DEBUG: setPrevViewport() function was launched.";
...
{
    qDebug() << "DEBUG: setNextViewport() function was launched.";
...
{
    qDebug() << "DEBUG: searchText() function was launched.";
...
void Document::processAction(const Action *action)
{
    ...
    qDebug() << "DEBUG: processAction() function was launched.";
...
{
    qDebug() << "DEBUG: processFormatAction() function was launched.";
...
{
    qDebug() << "DEBUG: processFocusAction() function was launched.";
...
{
    qDebug() << "DEBUG: processValidateAction() function was launched.";
    if (!action || action->actionType() != Action::Script) {
        return;
    }
...
{
    qDebug() << "DEBUG: dynamicSourceReference() function was launched.";
    if (!d->m_synctex_scanner) {
        return nullptr;
    }
...
{
    qDebug() << "DEBUG: printConfigurationWidget() function was launched.";
    if (d->m_generator) {
...
{
    qDebug() << "DEBUG: supportedMimeTypes() function was launched.";
...
{
    qDebug() << "DEBUG: swapBackingFile() function was launched.";
    if (!d->m_generator) {
        return false;
    }
...
{
    qDebug() << "DEBUG: registerView() function was launched.";
    if (!view) {
        return;
    }
...
{
    qDebug() << "DEBUG: fontData() function was launched.";
    QMimeDatabase db;
...
{
    qDebug() << "DEBUG: openDocumentArchive() function was launched.";
...
{
    qDebug() << "DEBUG: saveDocumentArchive() function was launched.";
    if (!d->m_generator) {
        return false;
    }
...
{
    qDebug() << "DEBUG: orientation() function was launched.";
    double width, height;
...
{
    qDebug() << "DEBUG: walletDataForFile() function was launched.";
    if (d->m_generator) {
...
{
    qDebug() << "DEBUG: requestSignedRevisionData() function was launched.";
...
{
    qDebug() << "DEBUG: refreshPixmaps() function was launched.";
    d->refreshPixmaps(pageNumber);
}

void DocumentPrivate::executeScript(const QString &function)
{
    qDebug() << "DEBUG: executeScript() function was launched.";
    if (!m_scripter) {
        m_scripter = new Scripter(this);
    }
...
{
    qDebug() << "DEBUG: requestDone() function was launched.";
    if (!req) {
        return;
    }
...
{
    qDebug() << "DEBUG: setPageBoundingBox() function was launched.";
    Page *kp = m_pagesVector[page];
    if (!m_generator || !kp) {
        return;
    }
...
{
    qDebug() << "DEBUG: calculateMaxTextPages() function was launched.";
    int multipliers = qMax(1, qRound(getTotalMemory() / 536870912.0)); // 512 MB
    switch (SettingsCore::memoryLevel()) {
    case SettingsCore::EnumMemoryLevel::Low:
        m_maxAllocatedTextPages = multipliers * 2;
        qDebug() << "DEBUG: calculateMaxTextPages() function was launched. low nemory:" << m_maxAllocatedTextPages;
        break;
...
{
    qDebug() << "DEBUG: textGenerationDone() function was launched.";
    if (!m_pageController) {
        return;
    }
...
{
    qDebug() << "DEBUG: setRotation() function was launched.";
    d->setRotationInternal(r, true);
}

void DocumentPrivate::setRotationInternal(int r, bool notify)
{
    qDebug() << "DEBUG: setRotationInternal() function was launched.";
...
DocumentViewport::DocumentViewport(int n)
    : pageNumber(n)
{
    qDebug() << "DEBUG: DocumentViewport() function was launched.";
    // default settings
    rePos.enabled = false;
...
{
    qDebug() << "DEBUG: toString() function was launched.";
