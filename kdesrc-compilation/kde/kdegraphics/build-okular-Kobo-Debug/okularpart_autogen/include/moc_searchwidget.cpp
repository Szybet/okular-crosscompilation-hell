...
#include <memory>
#include "../../../okular/part/searchwidget.h"
...
QT_MOC_LITERAL(1, 13, 14), // "slotMenuChaged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8) // "QAction*"

    },
    "SearchWidget\0slotMenuChaged\0\0QAction*"
};
...
void SearchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotMenuChaged((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
