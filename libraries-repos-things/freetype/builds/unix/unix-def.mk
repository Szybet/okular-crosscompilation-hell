...
#
PKG_CONFIG                 := /sbin/pkg-config
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := zlib, bzip2, libpng, libbrotlidec
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := 
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 25.0.19
