...
CMakeFiles/fetch-translations: releaseme
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/HDD/Project/Public/okulartry/kcoreaddons/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Downloading translations for KCoreAddons branch trunk..."
	git -C /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/releaseme pull
	cmake -E remove_directory /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/po
	cmake -E remove_directory /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/poqm
	ruby /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/releaseme/fetchpo.rb --origin trunk --project KCoreAddons --output-dir /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/po --output-poqm-dir /mnt/HDD/Project/Public/okulartry/kcoreaddons/build/poqm /mnt/HDD/Project/Public/okulartry/kcoreaddons

releaseme:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/HDD/Project/Public/okulartry/kcoreaddons/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Fetching releaseme scripts to download translations..."
